...
// шахматы a1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cшахматыa1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Cшахматыa1App

Cшахматыa1App::Cшахматыa1App()
{
...
// Единственный объект Cшахматыa1App

Cшахматыa1App theApp;


// инициализация Cшахматыa1App

BOOL Cшахматыa1App::InitInstance()
{
